...
@section('title', 'Edit Selection - Admin Dashboard')
@section('page-title', 'Edit Selection')
    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <i class="fas fa-edit"></i> Edit Design Selection
            </div>
            <div class="card-body">
                @if ($errors->any())
                ...
                <form action="{{ route('admin.selections.update', $selection->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" 
                               placeholder="e.g., Metal Type, Stone Type, Design Style" value="{{ old('title', $selection->title) }}" required>
                        @error('title')
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="text" id="prompt_template" name="prompt_template" class="form-control @error('prompt_template') is-invalid @enderror" 
                               placeholder="e.g., The jewelry should be made of {value}" value="{{ old('prompt_template', $selection->prompt_template) }}">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <div id="valuesContainer">
                            @foreach($selection->values as $index => $value)
                    ...
                    <div class="form-group mb-4">
                        <div class="form-check">
                            <input type="checkbox" id="is_active" name="is_active" class="form-check-input" value="1" 
                                   {{ old('is_active', $selection->is_active) ? 'checked' : '' }}>
